...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String deviceName = "eSense-0841";  // "eSense-0598"
    private String activityName = "Activity";
    private int timeout = 30000;

    private Button connectButton;
    private Button chewingButton;
    private Button talkingButton;
    private Button sittingIdleButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chewingButton = (Button) findViewById(R.id.chewingButton);
        talkingButton = (Button) findViewById(R.id.talkingButton);
        sittingIdleButton = (Button) findViewById(R.id.sittingIdleButton);
        eatingButton = (Button) findViewById(R.id.eatingButton);
        walkButton = (Button) findViewById(R.id.walkButton);
        drinkingButton = (Button) findViewById(R.id.drinkingButton);
        activityButton = (Button) findViewById(R.id.activityButton);

        recordButton.setOnClickListener(this);
        connectButton.setOnClickListener(this);
        chewingButton.setOnClickListener(this);
        talkingButton.setOnClickListener(this);
        sittingIdleButton.setOnClickListener(this);
        eatingButton.setOnClickListener(this);
        walkButton.setOnClickListener(this);
        drinkingButton.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.chewingButton:
                activityName = "Chewing";
                sharedPrefEditor.putString("activityName", activityName);
                sharedPrefEditor.commit();
                setActivityName();
                break;

            case R.id.talkingButton:
                activityName = "Talking";
                sharedPrefEditor.putString("activityName", activityName);
                sharedPrefEditor.commit();
                setActivityName();
                break;

            case R.id.sittingIdleButton:
                activityName = "Sitting Idle";
                sharedPrefEditor.putString("activityName", activityName);
                sharedPrefEditor.commit();
                setActivityName();
                break;
            ...
            case R.id.drinkingButton:
                activityName = "Drinking";
                sharedPrefEditor.putString("activityName", activityName);
                sharedPrefEditor.commit();
                setActivityName();
                break;
